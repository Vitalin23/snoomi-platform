...
- активируется trial (30 дней),
- лимиты trial: до 15 авто-публикаций, до 5 ручных публикаций, до 15 тем в плане,
- привязка карты на старте не требуется,
- тарифы запрашиваются отдельной кнопкой в кабинете (`/request-tariff`),
